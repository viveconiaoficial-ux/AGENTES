...
export default async function DemoClientePage({
  ...
  return (
    <main
      className={
        embedMode
          ? "relative min-h-0 w-full overflow-y-auto overflow-x-hidden overscroll-y-contain bg-transparent text-white [min-height:100dvh] [min-height:100svh]"
